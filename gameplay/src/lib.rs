...
pub use stored_project::{
    authored_node_fields, decode_stored_project, decoded_authored_scene, diagnostic_code,
    stored_light, AuthoredNodeFields, ProjectDiagnostic, StoredArmorGrantMode,
    ...
    StoredEntityDefinition, StoredEntityPresentation, StoredExplosiveProp, StoredExtractionBeacon,
    StoredFloorAction, StoredGeneratedVoxelEnvironment, StoredHazard, StoredHealth,
    StoredImportSource, StoredInventory, StoredInventoryStack, StoredItemDefinition,
    StoredItemKind, StoredKinematic, StoredLevelExit, StoredLift, StoredLight,
    StoredLoadingBayInterlock, StoredMaterialVoxel, StoredMaterialVoxelEnvironment,
    StoredNavigation, StoredPickup, StoredPlayerController, StoredPlayerInputBindings,
    StoredProject, StoredProjectError, StoredRequiredKeyPolicy, StoredScene, StoredSecretRegion,
