...
mod tests {
    ...
    fn voxel_doom_closure_rejects_missing_material() {
        ...
        let project = StoredProject {
            ...
            gameplay_programs: Vec::new(),
            pickup_programs: Vec::new(),
            player_setup_programs: Vec::new(),
            enemy_attack_programs: Vec::new(),
            enemy_defeat_programs: Vec::new(),
            hazard_programs: Vec::new(),
            explosive_prop_programs: Vec::new(),
            encounter_programs: Vec::new(),
            switch_programs: Vec::new(),
            floor_action_programs: Vec::new(),
            lift_programs: Vec::new(),
            secret_programs: Vec::new(),
            level_exit_programs: Vec::new(),
            scenes: Vec::new(),
        };
