...
| Do not use copied renderer packages, Three internals, selective Engine crate paths, or revision machinery | Forks reusable authority and breaks the complete facade | dependency/path/package and active-guidance checks in `audit:boundary`                          |
