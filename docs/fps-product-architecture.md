...
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Rust runtime         | `LoadingBayGameLoop` owns a fixed 60 Hz phase order over `GameRuntime`: input, player motion, bounded encounter activation, enemy intent/motion, hazards, combat, interactions/pickups, scheduled consequences, and projection/fact drain. Responsible components plus named services own inventory, vitality, hazards, three explicit weapon modes, progression, enemy perception/pursuit/attacks, exact-once defeat drops, and all resulting damage.                                                            | The complete route and full save/checkpoint semantics remain in #6229–#6230.                                            |
...
| Browser presentation | The Angular/Nx shell provides a working main menu, continue flow, authoritative HUD/hotbar, live inventory, Rust pause, host settings, visible typed rejections, and responsive overlays around one shared auto-started renderer surface. Three original primitive weapon silhouettes, bob, recoil, and muzzle flash are disposable descriptor state derived from accepted Rust projection/facts. Its diagnostic drawer reports renderer cadence and backend submission separately.                               | Later campaign tasks complete level content and audiovisual polish without moving gameplay authority into presentation. |
| Content              | TypeScript composes immutable schema-19 project JSON. Responsible objects own vitality, hazards, weapons, keys/doors/switches/secrets/exits, concrete melee/ranged enemy combat configuration, bounded encounter activation, and defeat-drop relationships. Rust alone owns live quantities, armor, cooldowns, spread, progression, encounter state, perception memory, pursuit, attacks, damage, death, drop materialization, and mutation facts. Legacy schemas reject future behavior fields before migration. | The complete original route remains downstream game content in #6229.                                                   |
| Live persistence     | `GameSnapshot` schema 18 round-trips entities, collision, doors, switches, enemy vitality and combat posture/memory/cooldowns, encounter activation, defeat-drop state, player health/armor/death, hazards, navigation, controllers, explicit weapon modes, item definitions, inventory/equipment/cooldowns, pickups, progression, schedules, and tick. `ProjectStore` separately persists authored project content.                                                                                              | #6230 adds save slots/checkpoints without persisting connection, derived routes/queries, or presentation state.         |
