...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| Rust runtime         | `LoadingBayGameLoop` owns a fixed 60 Hz phase order over `GameRuntime`: input, player motion, enemy intent/motion, hazards, combat, interactions/pickups, scheduled consequences, and projection/fact drain. Responsible components plus named services own inventory, vitality, hazards, combat, and progression mutations.                                                                | Enemy attacks, key/secret/exit progression, and full save/checkpoint semantics remain in #6224 and #6226–#6230.                           |
...
| Content              | TypeScript composes immutable schema-15 project JSON. Health owns maximum vitality, hitbox, armor capacity, and absorption; hazard objects own damage and cadence. Weapon/item definitions remain immutable content while Rust alone owns live quantities, armor, cooldowns, pickup/hazard state, death, and mutation facts. Legacy schemas reject future vitality fields before migration. | Key progression, enemy archetypes, and the complete original route remain downstream game content and semantics in #6224 and #6226–#6229. |
| Live persistence     | `GameSnapshot` schema 14 round-trips entities, collision, doors, switches, enemies, complete health/armor/death state, hazards and cadence, encounters, navigation, controllers, item definitions, inventory/equipment/cooldowns, pickup state, schedules, and tick. `ProjectStore` separately persists authored project content.                                                           | #6230 adds save slots/checkpoints without persisting connection or presentation state.                                                    |
