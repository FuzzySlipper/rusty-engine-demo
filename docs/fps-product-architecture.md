...
| Browser presentation | The Angular/Nx shell provides a working main menu, continue flow, authoritative HUD/hotbar, live inventory, Rust pause, host settings, visible typed rejections, and responsive overlays around one shared auto-started renderer surface. Its diagnostic drawer reports renderer cadence and backend submission separately; typed feedback remains disposable.                                                                                                                                                    | #6224 adds the shared-renderer viewmodel after #6263; save/load slots and later progression states arrive with their owning gameplay tasks.                |
