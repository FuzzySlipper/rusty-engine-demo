...
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Rust runtime         | `LoadingBayGameLoop` owns a fixed 60 Hz phase order over `GameRuntime`: input, player motion, enemy intent/motion, hazards, combat, interactions/pickups, scheduled consequences, and projection/fact drain. Responsible components plus named services own inventory, vitality, hazards, three explicit weapon modes, progression, enemy perception/pursuit/attacks, and all resulting damage.                   | Deterministic drops, richer encounter content, and full save/checkpoint semantics remain in #6228–#6230.                                                   |
...
| Content              | TypeScript composes immutable schema-18 project JSON. Responsible objects own vitality, hazards, weapons, keys/doors/switches/secrets/exits, and concrete melee/ranged enemy combat configuration. Rust alone owns live quantities, armor, cooldowns, spread, progression, perception memory, pursuit, attacks, damage, death, and mutation facts. Legacy schemas reject future behavior fields before migration. | Distinct archetype/drop content and the complete original route remain downstream game content in #6228–#6229.                                             |
| Live persistence     | `GameSnapshot` schema 17 round-trips entities, collision, doors, switches, enemy vitality and combat posture/memory/cooldowns, player health/armor/death, hazards, encounters, navigation, controllers, explicit weapon modes, item definitions, inventory/equipment/cooldowns, pickups, progression, schedules, and tick. `ProjectStore` separately persists authored project content.                           | #6230 adds save slots/checkpoints without persisting connection, derived routes/queries, or presentation state.                                            |
