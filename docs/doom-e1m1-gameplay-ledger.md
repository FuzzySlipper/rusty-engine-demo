...
| Concern            | E1M1 calibration facts                                                                                                                                                    | Current authored product                                                                                                                                                                                                                                                                 | Reusable owner / campaign task                                                 |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Start state        | One player-1 start at Doom `(1056,-3616)`, angle `90`; world anchor `(114,78)` on floor surface `9`                                                                       | Player center `[114,9.5,78]`; 100 health, 0 armor, Fist and Pistol owned, Pistol equipped, and 50 bullets                                                                                                                                                                                | Player definition, inventory, and survivability / #6804, #6805                 |
| Traversal          | Route contains adjacent 8-, 16-, and 24-unit floor changes plus larger non-step height separations; four damaging nukage sectors and one repeatable lift are on the map   | The canonical FPS controller owns grounded motion, 1.5-unit steps, gravity, and jump; 8-unit source changes remain quantized by the 16-unit voxel conversion                                                                                                                             | Player locomotion and collision service / #6802, #6893                         |
| Doors and triggers | Eight type-1 boundary linedefs describe four logical manual-door sectors; one type-36 walk-once floor action; one type-88 repeatable lift action; one type-11 exit switch | Four logical door entities, the walk-once floor action, repeatable rider-carrying lift, and radius exit interaction are live Rust-owned objects                                                                                                                                          | Door, trigger, lift, switch, and exit objects / #6803                          |
| Secrets            | Three sector-special-9 regions: sectors 68, 69, and 70                                                                                                                    | All three secret regions are authored and retain first-entry discovery state                                                                                                                                                                                                             | Secret-region owner / #6803                                                    |
| Keys               | No key Things and no keyed route requirement in E1M1                                                                                                                      | No key definitions or pickups are authored                                                                                                                                                                                                                                               | No E1M1 key work; keep reusable inventory capable without surfacing keys here  |
| Weapons            | Single-player set is the starting fist and pistol plus shotgun. One shotgun Thing is placed; the 16 UV shotgun guys are an additional drop source                         | Fist, pistol, and placed shotgun are the only authored weapon definitions and slots; multiplayer-only chaingun and rocket-launcher Things are excluded. Each shotgun guy drops one shotgun with four starter shells; collecting a duplicate consumes the drop and grants only the shells | Weapon definitions, equipment, firing, drops / #6804, #6807                    |
| Ammunition         | Single-player bullets and shells only: 2 clips, 1 bullet box, 2 loose shell pickups, and 3 shell boxes on UV, plus enemy drops                                            | Exact placed incidence and quantities are authored, with 50 starting bullets and eight shells on placed-shotgun collection. Shotgun guys drop four shells with their weapon, zombiemen drop five bullets, and imps drop nothing                                                          | Item definitions, pickup transaction, weapon ammo policy / #6804, #6805, #6807 |
| Health and armor   | 1 stimpack, 3 medikits, 13 health bonuses, 25 armor bonuses, 1 green armor, and 1 blue armor on UV                                                                        | Exact incidence and effects are authored: +10/+25 to 100, +1 health to 200, +1 armor to 200, green 100 at one-third absorption, blue 200 at one-half                                                                                                                                     | Pickup, bounded tracks/effects, and authored tuning / #6805                    |
| Enemies            | UV: 16 shotgun guys (type 9), 4 imps (3001), and 9 zombiemen (3004). Medium has 2 imps and 4 zombiemen                                                                    | Exact UV identities, positions, source rotations, health (30/60/20), distinct hitscan/projectile attacks, pain/death state, collision, and drops are authored as three archetypes over 29 live instances and four no-exit encounter groups                                               | Enemy archetypes, encounter instances, combat, drops / #6807                   |
| Hazards and props  | Four special-7 damaging nukage sectors and 6 explosive barrels (type 2035) affect play                                                                                    | Four sector hazards apply 5 damage every 55 fixed ticks. Six live barrels have 20 health and produce a 128-damage, 8-world-unit line-of-sight/falloff explosion with stable exactly-once chain reactions                                                                                 | Hazard/damage owner and encounter world objects / #6805, #6807                 |
...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Player start      | 100 health, 0 armor, Fist and Pistol owned, Pistol equipped, 50 bullets; shells/cells/missiles 0                                | Health, armor, owned Fist/Pistol, equipped Pistol, and 50 starting bullets match                                                                                                         |
...
| Damaging floor    | Special 7 applies 5 damage every 32 source tics without protection                                                              | Four sector-sourced hazard objects apply 5 damage every 55 fixed ticks                                                                                                                   |
...
| L2  | Western green-armor court; type-2018 Thing `(-224,-3232)`, world `(34,102)`                                                                            | Sector 32: floor `128`, ceiling `264`, 136-unit / 8.5-world-unit clearance; floor surface `17`. This is an 8-world-unit elevation and major enclosure transition from L1                                          | The exact green armor pickup raises armor to 100 when stronger and owns one-third absorption; the exact UV enemy identities and portable combat semantics are live                                                                                                      | The same task #6802 run arrives near `[34,17.25,102]` on authoritative surface `17` after held-key traversal across admitted surfaces `9, 11, 12, 14, 15, 16, 17`; retained before/after images show the enclosure transition, and physical Space input leaves ground and lands at L2. |
| L3  | Central nukage field; representative sector-13 point `(1824,-3276)`, world `(162,99.25)`                                                               | Sector 13: damaging special 7, floor `-80`, ceiling `216`, 296-unit / 18.5-world-unit clearance, sky ceiling, floor surface `4`; nearby route edges include 8-, 16-, and 24-unit height changes                   | The sector hazard applies 5 damage every 55 fixed ticks; sky openings now reveal the source `SKY1` panorama through Engine's camera-relative background contract; all six source barrels have live damage, falloff, occlusion, and chain consequences                         | The exact task #6806 interaction route crossed the central field under physical held-key control and continued to L4/L5 without a collision stop. Task #6967 adds a bounded visible exterior-sky observation without changing collision or route authority.                           |
| L4  | Eastern lift and shotgun-secret chain; type-88 line midpoint `(2900,-2964)` / world `(229.25,118.75)`, shotgun Thing `(3264,-3936)` / world `(252,58)` | Repeatable lift line is 340.35 Doom units long and targets tag 2. Secret sector 69 has floor `-48`, ceiling `32`, 80-unit / 5-world-unit clearance and contains the placed shotgun. Sectors 68-70 are all secrets | The repeatable lift carries a supported player while moving; all three secret regions, the exact placed shotgun, authored enemy pressure, and source-appropriate enemy drops are live                                                                                   | Task #6806 exact-clean interaction evidence at `ceb3bd6bd2b3e4381326b892c39884577a17dfdb` captures physical traversal while lift owner 95 is moving and the sector-68 secret chain. The E1M1 shell remains legible at normal scale without internal navigation spam.                   |
| L5  | Exit annex; type-36 midpoint `(3008,-4160)` / world `(236,44)`, exit line midpoint `(2912,-4768)` / world `(230,6)`                                    | Walk-once floor action precedes a 64-unit-wide type-11 exit switch. Exit sector 82 has floor `-24`, ceiling `88`, 112-unit / 7-world-unit clearance and floor surface `7.5`                                       | The one-shot floor action, logical exit door, typed switch prompt, and immediate Rust-owned level completion are authored and live                                                                                                                                      | The same exact task #6806 route physically opened exit door 90, activated exit owner 96, and retained the visible `DOOM E1M1 COMPLETE` / `Restart E1M1` result. The route reached completion without a collision or interaction snag.                                                  |
...
| Closed   | Player body, start vitality/inventory, eye height, grounded movement, jump, and the 24-unit step limit are authored                | L1 and all traversal         | #6802 and #6893                                                                         |
| Closed   | Four logical manual doors replace the earlier line-derived duplicates; floor, lift, secret, and exit owners are explicit           | L1, L4, L5                   | #6803                                                                                   |
| Closed   | The repeatable lift, walk-once floor action, all three secrets, and six explosive barrels now have live Rust-owned behavior        | L3-L5                        | #6803 and #6807 closed the bounded behaviors                                            |
| Closed   | Exact UV enemy identities, attacks, health, pain/death state, collision, and drops now preserve the three authored E1M1 archetypes | Route-wide, especially L3-L5 | #6807                                                                                   |
| Closed   | Health, armor, bullet, and shell pickup categories were collapsed or omitted before #6804/#6805                                    | Route-wide                   | Exact placed incidence, caps, eligibility, effects, and atomic removal are now authored |
...
| Closed   | Sky ceilings previously rendered as clear-color openings                                                                          | L3 / exterior views          | #6967 projects source `SKY1` through Engine task #6968's authored background contract   |
...
## Task #6806 selected polish evidence

Task #6806 used one exact-clean physical L1-to-L2 pass before implementation and one exact-clean
full interaction pass after implementation. The pre-fix packet is
`/home/agent/.codex/playtester/runs/rusty-engine-demo/task-6806-l1-l2-1bc5e8da46a113047823b5f0582a7ef2588989b8/playtest-index.json`.
The rebuilt after-fix product packet is
`/home/agent/.codex/playtester/runs/rusty-engine-demo/task-6806-interactions-ceb3bd6bd2b3e4381326b892c39884577a17dfdb/playtest-index.json`.
Both use Chromium physical key-down/key-up and E input through the browser semantic-input path and
Rust fixed-step loop; authoritative state steers and verifies the route but does not teleport or
mutate it.

| Issue   | Landmark observation and product impact                                                                                                                                                                                                                                                                                 | Owner and disposition                                                                                                                                                                                                                                                                                                                  | Proportionate evidence                                                                                                                                                                                                                             |
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P6806-1 | At L1 and throughout the route, the Doom session visibly said `Loading Bay 03`, `EXIT / NORTH BULKHEAD`, `Restart loading bay`, `LOADING`, `REV —`, and `AUDIO WAITING`. This made the delivered product look like a debug skin over the wrong game and made completion contradict its own `Doom E1M1 complete` result. | Disposable Angular shell presentation in `main-menu.component.ts` and `game-screen.component.ts`. The shell now selects existing-product labels from Rust's projected `projectId`, presents live/complete session state, removes the false audio-waiting claim, hides the irrelevant E1M1 key box, and preserves Loading Bay defaults. | Pre-fix L1 screenshot at exact `1bc5e8d…`; rebuilt after-fix L1, L4, and L5 captures at exact `ceb3bd6…` show `DOOM E1M1`, `PROJECT DOOM-E1M1`, `RUST SESSION CONNECTED`, `EXIT / HANGAR`, `IN PROGRESS`, and the exact completion/restart labels. |
| P6806-2 | At L2 and L4, repeated `NavigationUnreachable`/`NavigationBlocked` records displaced useful player feedback in the visible committed-facts panel, and a later exact L2 capture exposed the equally non-actionable input-liveness fact `InputExpired`.                                                                   | Angular combat-log projection only. `Navigation*`, `EnemyPostureChanged`, and `InputExpired` stay in the authoritative snapshot/diagnostics but are excluded from the seven-row player-facing log.                                                                                                                                     | The exact pre-fix L2 image shows the navigation flood. Rebuilt L4/secret captures show only bounded player-facing facts while the same Rust route and enemy state continue; the final exact-clean L1-to-L2 pass bounds the input-liveness cleanup. |
| P6806-3 | The retained interaction route initially stopped at the first door after later authored pickup growth shifted entity IDs. That was evidence-harness drift, not a product interaction failure.                                                                                                                           | On-demand evidence script. It now resolves the existing authored door, lift, floor, secret, and exit owners by stable object name and required component instead of stored array IDs. Normal CI was not expanded.                                                                                                                      | Exact `ceb3bd6…` readback opened current door owners `88, 89, 91, 90`, traversed moving lift `95`, recorded secret `97`, and completed exit `96`; browser/profile/host/save cleanup all passed.                                                    |

The bounded L1-to-L2 pass took 28.854 seconds across admitted floor surfaces
`9,10,11,13,14,16,17`, then jumped and landed with zero vertical velocity. It reproduced no
player-scale, camera-handedness, or collision snag requiring a calibration change. The interaction
pass continued through L3-L5 and completed the level, so no hidden route-blocking polish issue was
observed outside the separately owned #6807 enemy/barrel work. This is a bounded product
observation, not a broad visual grade.

Audible feedback remains explicitly uncertified: the product-playtest broker had no manifest for
this repository and returned `infrastructure_error` before a live session, and the retained browser
route does not capture audio. Task #6806 removes the misleading `AUDIO WAITING` UI claim but does
not invent an auditory pass; human-like audio judgement remains on-demand work for #6808/#6809.
