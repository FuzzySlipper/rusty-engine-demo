...
| Weapons            | Single-player set is the starting pistol plus shotgun. One shotgun Thing is placed; the 16 UV shotgun guys are an additional drop source                                  | Arc Pistol plus Breach Scattergun, Rivet Carbine, and Kinetic Launcher. The latter two are sourced from multiplayer-only chaingun and rocket-launcher Things                     | Weapon definitions, equipment, firing, drops / #6804, #6807                   |
| Ammunition         | Single-player bullets and shells only: 2 clips, 1 bullet box, 2 loose shell pickups, and 3 shell boxes on UV, plus enemy drops                                            | Clips become Energy Cells; loose shells become Scatter Shells; bullet/shell boxes are omitted; multiplayer-only placements are admitted                                          | Item definitions, pickup transaction, weapon ammo policy / #6804, #6805       |
...
| Ordinary step     | Maximum step-up and supported drop-off 24 Doom units / 1.5 world units                                                          | No grounded configurable step policy; 8-unit source changes are also aliased by voxel quantization                                                                                       |
...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| L1  | Start room; player Thing `(1056,-3616)`, world `(114,78)`                                                                                              | Sector 38: floor `0`, ceiling `72`, 72-unit / 4.5-world-unit clearance; floor surface `9`                                                                                                                         | Player center is `0.5` world unit above the admitted floor. Browser presentation adds `1.2` eye units, while the native rendered product currently adds `1.5`; neither value is authored E1M1 calibration. The invented switch is only about 2 world units from spawn | Not yet recorded. Capture initial eye-to-door proportion, first doorway width, target readability, and time to leave the room                 |
| L2  | Western green-armor court; type-2018 Thing `(-224,-3232)`, world `(34,102)`                                                                            | Sector 32: floor `128`, ceiling `264`, 136-unit / 8.5-world-unit clearance; floor surface `17`. This is an 8-world-unit elevation and major enclosure transition from L1                                          | The armor is represented as the same unique Impact Vest used for every armor Thing; the current encounter roster is present but not semantically exact                                                                                                                | Not yet recorded. Measure transition time from L1, perceived exterior scale, sight-line distance, armor readability, and return-route clarity |
...
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- | ------------------------------------------------------------------------------- |
| P0       | Multiplayer-only weapon and ammunition Things are admitted into the single-player project                                                     | L4 and route-wide content    | #6804, #6805                                                                    |
| P0       | Player body, eye height, start inventory, and 24-unit step calibration do not match the source baseline                                       | L1 and all traversal         | #6802, #6804, #6805                                                             |
...
| P1       | Native and browser camera eye offsets disagree and both are currently product constants rather than authored calibration                      | L1-L5                        | #6802; visual follow-up #6806                                                   |
