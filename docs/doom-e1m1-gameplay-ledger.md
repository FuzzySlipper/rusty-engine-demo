...
| L3  | Central nukage field; representative sector-13 point `(1824,-3276)`, world `(162,99.25)`                                                               | Sector 13: damaging special 7, floor `-80`, ceiling `216`, 296-unit / 18.5-world-unit clearance, sky ceiling, floor surface `4`; nearby route edges include 8-, 16-, and 24-unit height changes                   | The sector hazard applies 5 damage every 55 fixed ticks; sky remains a clear-color opening; all six source barrels now have live damage, falloff, occlusion, and chain consequences                                                                                     | The exact task #6806 interaction route crossed the central field under physical held-key control and continued to L4/L5 without a collision stop. No separate L3 visual judgement is claimed; enemy/barrel product readability remains #6807/#6808 evidence work.                      |
